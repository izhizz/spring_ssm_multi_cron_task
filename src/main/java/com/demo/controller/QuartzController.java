...
import com.demo.persistence.entity.JobEntity;
import com.demo.service.QuartzService;
import com.demo.task.HelloWorldJob;
import org.quartz.*;
...
public class QuartzController {
	...
	public String add(HttpServletRequest request, HttpServletResponse response) throws SchedulerException, ClassNotFoundException {
		HelloWorldJob helloWorldJob = new HelloWorldJob();
		System.out.println(helloWorldJob.getClass());
